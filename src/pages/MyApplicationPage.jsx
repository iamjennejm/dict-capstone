                      ...
                      <div class="flex items-center flex-1 min-w-0">
                        ...
                        <div class="mt-0 mr-0 mb-0 ml-4 flex-1 min-w-0">
                          <p class="text-lg font-bold text-gray-800 truncate">
                            Service Desk Support I for a Technology Solutions
                            Account
                          </p>
                          ...
                          <p class="text-gray-300 text-sm">
                            National Capital Reg | 29-Jun-23
                          </p>
                        </div>
                      </div>
                  ...
                  <div class="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                    <div class="sm:flex sm:items-center sm:justify-between sm:space-x-5">
                      ...
                      >
                        <a
                          href=""
                          class="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 border border-gray-400 shadow rounded-lg"
                        >
                          Apply
                        </a>
                      </div>
