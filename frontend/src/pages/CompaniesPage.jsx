            ...
            <div class=" pt-12 pr-0 pb-12 pl-0 mt-0 mr-auto mb-0 ml-auto sm:py-16 lg:py-20">
                <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto max-w-7xl sm:px-6 lg:px-8">
                    ...
                    <div class="pt-0 pr-4 pb-0 pl-4 mt-0 mr-auto mb-0 ml-auto sm:flex sm:items-center sm:justify-between">
                        <div>
                        <p class="text-2xl font-bold text-gray-900">Companies</p>
                        <p class="text-xl mt-1 mr-0 mb-0 ml-0 font-semi-bold text-gray-500">Find a company..</p>
                        </div>
                        <div class="mt-4 mr-0 mb-0 ml-0 sm:mt-0">
                        <p class="sr-only">Search Company</p>
                        <div class="relative">
                            ...
                            <input placeholder="Search Companies " type="search" class="border block pt-2 pr-0 pb-2 pl-10 w-full py-2
                    ...
                    <div class="shadow-xl mt-8 mr-0 mb-0 ml-0 pt-4 pr-10 pb-4 pl-10 flow-root rounded-lg sm:py-2">
                        ...
                        <div class="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                            ...
                            <div class="companyborder flex items-center flex-1 min-w-0">
                                ...
                                <p class="text-lg font-bold text-gray-800 truncate">Concentrix Philippines</p>
                                <p class="text-gray-600 text-md">Service Desk Support I for a Technology Solutions Account</p>
                        ...
                        <div class="pt-5 pr-0 pb-0 pl-0 mt-5 mr-0 mb-0 ml-0">
                            ...
                            <div class="companyborder flex items-center flex-1 min-w-0">
                                ...
                                <p class="text-gray-600 text-md">Senior Software Engineer</p>
